      ...
      <Container>
        <Content>
          <WorkerContainer>
            ...
            <WorkerName>{worker.first_name + ' ' + worker.last_name}</WorkerName>
          </WorkerContainer>

          <HomeShortcutsButtons>

            <ShortcutButton onPress={() => navigation.navigate('EditProfile')}>
              <ShortcutDetail>
                <ShortcutDeatailIcon>
            ...
            <ShortcutButton  style={{marginTop: 32}} onPress={() => setShowRemoveModal(true)}>
              <ShortcutDetail>
                <ShortcutDeatailIcon>
                  <Icon name="trash-2" size={24} color="#F38725" />
                </ShortcutDeatailIcon>
                <ShortcutName style={{color: 'red'}}>Excluir conta</ShortcutName>
              </ShortcutDetail>
              <Icon name="chevron-right" size={24} color="#F38725" />
            </ShortcutButton>
          ...
          <RemoveProfile handleVisible={setShowRemoveModal} visible={showRemoveModal} />
        </Content>
