...
import {Container, PageContent, Title, MediaContainer, TextContent, ImageContent, Credits} from './styles';
    ...
    <InnerPages name="Notícias">
      ...
      <Container>
        <PageContent>
            ...
            {post.featured_image && (
              <MediaContainer>
                <ImageContent source={{uri: post.featured_image}} style={{width: '100%', height: 220}} resizeMode="contain" />
                {/* <Credits>Foto 1: com homem na tela é de Dariusz Misztal</Credits> */}
              </MediaContainer>
            )}

            <ListenNews postId={post.id} postTitle={post.title} />
